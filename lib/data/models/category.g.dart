...
void _categorySerialize(
  ...
  writer.writeDouble(offsets[0], object.monthlyBudget);
...
Category _categoryDeserialize(
  ...
  object.id = id;
  object.monthlyBudget = reader.readDoubleOrNull(offsets[0]);
...
extension CategoryQueryFilter
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> monthlyBudgetEqualTo(
    double? value, {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> monthlyBudgetLessThan(
    double? value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Category, Category, QAfterFilterCondition> monthlyBudgetBetween(
    double? lower,
    double? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension CategoryQuerySortBy on QueryBuilder<Category, Category, QSortBy> {
  QueryBuilder<Category, Category, QAfterSortBy> sortByMonthlyBudget() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'monthlyBudget', Sort.asc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> sortByMonthlyBudgetDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryQuerySortThenBy
  ...
  QueryBuilder<Category, Category, QAfterSortBy> thenByMonthlyBudget() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'monthlyBudget', Sort.asc);
    });
  }

  QueryBuilder<Category, Category, QAfterSortBy> thenByMonthlyBudgetDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'monthlyBudget', Sort.desc);
    });
  }
...
extension CategoryQueryWhereDistinct
  ...
  QueryBuilder<Category, Category, QDistinct> distinctByMonthlyBudget() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryQueryProperty
  ...
  QueryBuilder<Category, double?, QQueryOperations> monthlyBudgetProperty() {
    return QueryBuilder.apply(this, (query) {
